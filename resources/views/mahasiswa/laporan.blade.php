                    ...
                    <div class="card card-plain">
                        ...
                        <div class="card-body p-3">
                            <!-- <span class="btn btn-info btn-file">
                                ...
                                <input type="file" name="laporan_sekolah_file" id="laporan_sekolah_file" onchange="uploadFile(event,'laporan_sekolah','create')" required multiple>
                            </span> -->
                            <!-- <div id="show-laporan-sekolah"> -->
                            <div>
                                <h5>Sementara pengembangan</h5>
                            </div>
                        </div>
                    </div>
                </div>
